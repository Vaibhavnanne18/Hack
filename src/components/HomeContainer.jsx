...
import Delivery from "../img/new/shark tank/DabblesharktankPI-06-removebg-preview.png";
import HeroBg from "../img/new/shark tank/Untitled design.png";
    ...
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <p className="text-[2.5rem] lg:text-[4.5rem] font-bold tracking-wide text-headingColor">
          Our Salads Have 
          <span className="text-orange-600 text-[3rem] lg:text-[5rem]"><br></br>
             Mom's Love
          </span>
        </p>
...
// git branch -M main
// git remote add origin https://github.com/Vaibhavnanne18/new.git
